...
Тексты в UI на английском. Вступают **13 August 2026**. Контакт: **legal@happyvote.xyz**.
...
- **Privacy** — публичное on-chain состояние vs private бюллетени; API tallies; каталог; логи хостинга.
...
Cookie / Privacy / GDPR фиксируют, что стороннего счётчика на поддомене нет.
